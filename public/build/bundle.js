    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			span = element("span");
    			span.textContent = "Me gusta aprender y proponerme retos. Me considero entusiasta y constante.\n      Me gusta la lectura y la buena música. Sé trabajar en equipo, escuchar y\n      acepto críticas. Responsable con el trabajo y ante la vida.";
    			add_location(h1, file$7, 1, 2, 25);
    			attr_dev(span, "class", "font-light italic");
    			add_location(span, file$7, 3, 4, 72);
    			attr_dev(div, "class", "mx-5");
    			add_location(div, file$7, 2, 2, 49);
    			attr_dev(article, "class", "mb-5");
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$6, 1, 2, 25);
    			attr_dev(span0, "class", "font-bold uppercase");
    			add_location(span0, file$6, 3, 4, 84);
    			attr_dev(span1, "class", "font-bold");
    			add_location(span1, file$6, 5, 6, 148);
    			attr_dev(span2, "class", "italic font-light");
    			add_location(span2, file$6, 6, 6, 192);
    			add_location(p0, file$6, 4, 4, 138);
    			attr_dev(span3, "class", "font-bold");
    			add_location(span3, file$6, 9, 6, 267);
    			attr_dev(span4, "class", "italic font-light");
    			add_location(span4, file$6, 10, 6, 312);
    			add_location(p1, file$6, 8, 4, 257);
    			attr_dev(div0, "class", "mx-5 mb-5");
    			add_location(div0, file$6, 2, 2, 56);
    			attr_dev(span5, "class", "font-bold uppercase");
    			add_location(span5, file$6, 19, 4, 678);
    			attr_dev(span6, "class", "font-bold");
    			add_location(span6, file$6, 21, 6, 741);
    			attr_dev(span7, "class", "italic font-light");
    			add_location(span7, file$6, 22, 6, 785);
    			add_location(p2, file$6, 20, 4, 731);
    			attr_dev(span8, "class", "font-bold");
    			add_location(span8, file$6, 25, 6, 871);
    			attr_dev(span9, "class", "italic font-light");
    			add_location(span9, file$6, 26, 6, 916);
    			add_location(p3, file$6, 24, 4, 861);
    			attr_dev(div1, "class", "mx-5 mb-5");
    			add_location(div1, file$6, 18, 2, 650);
    			attr_dev(span10, "class", "font-bold uppercase");
    			add_location(span10, file$6, 40, 4, 1685);
    			attr_dev(span11, "class", "font-bold");
    			add_location(span11, file$6, 42, 6, 1749);
    			attr_dev(span12, "class", "italic font-light");
    			add_location(span12, file$6, 43, 6, 1793);
    			add_location(p4, file$6, 41, 4, 1739);
    			attr_dev(span13, "class", "font-bold");
    			add_location(span13, file$6, 46, 6, 1874);
    			attr_dev(span14, "class", "italic font-light");
    			add_location(span14, file$6, 47, 6, 1919);
    			add_location(p5, file$6, 45, 4, 1864);
    			attr_dev(div2, "class", "mx-5 mb-5");
    			add_location(div2, file$6, 39, 2, 1657);
    			attr_dev(span15, "class", "font-bold uppercase");
    			add_location(span15, file$6, 55, 4, 2193);
    			attr_dev(span16, "class", "font-bold");
    			add_location(span16, file$6, 57, 6, 2257);
    			attr_dev(span17, "class", "italic font-light");
    			add_location(span17, file$6, 58, 6, 2301);
    			add_location(p6, file$6, 56, 4, 2247);
    			attr_dev(span18, "class", "font-bold");
    			add_location(span18, file$6, 63, 6, 2416);
    			attr_dev(span19, "class", "italic font-light");
    			add_location(span19, file$6, 64, 6, 2461);
    			add_location(p7, file$6, 62, 4, 2406);
    			attr_dev(div3, "class", "mx-5 mb-5");
    			add_location(div3, file$6, 54, 2, 2165);
    			attr_dev(article, "class", "mb-5");
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h10, file$5, 1, 2, 25);
    			add_location(li0, file$5, 4, 6, 117);
    			add_location(li1, file$5, 5, 6, 171);
    			add_location(li2, file$5, 6, 6, 228);
    			add_location(li3, file$5, 7, 6, 278);
    			add_location(li4, file$5, 8, 6, 342);
    			add_location(li5, file$5, 9, 6, 375);
    			add_location(ul0, file$5, 3, 4, 106);
    			attr_dev(div0, "class", "mx-5 mb-5 font-light italic");
    			add_location(div0, file$5, 2, 2, 60);
    			add_location(h11, file$5, 13, 2, 418);
    			add_location(li6, file$5, 16, 6, 506);
    			add_location(li7, file$5, 17, 6, 545);
    			add_location(li8, file$5, 18, 6, 614);
    			add_location(li9, file$5, 22, 6, 730);
    			add_location(li10, file$5, 23, 6, 802);
    			add_location(li11, file$5, 24, 6, 850);
    			add_location(li12, file$5, 25, 6, 901);
    			add_location(ul1, file$5, 15, 4, 495);
    			attr_dev(div1, "class", "mb-5 mx-5 font-light italic");
    			add_location(div1, file$5, 14, 2, 449);
    			attr_dev(article, "class", "mb-5");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", "italic font-light svelte-1u65q5");
    			add_location(span0, file$4, 4, 6, 78);
    			add_location(p, file$4, 3, 4, 68);
    			attr_dev(span1, "class", "svelte-1u65q5");
    			add_location(span1, file$4, 11, 19, 261);
    			attr_dev(li0, "class", "svelte-1u65q5");
    			add_location(li0, file$4, 11, 6, 248);
    			attr_dev(span2, "class", "svelte-1u65q5");
    			add_location(span2, file$4, 12, 18, 303);
    			attr_dev(li1, "class", "svelte-1u65q5");
    			add_location(li1, file$4, 12, 6, 291);
    			add_location(ul, file$4, 10, 4, 237);
    			attr_dev(div, "class", "mx-5");
    			add_location(div, file$4, 2, 2, 45);
    			attr_dev(article, "class", "mb-5 svelte-1u65q5");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "logo inline svelte-7gmkau");
    			add_location(img, file$2, 10, 6, 253);
    			attr_dev(div0, "class", "py-4 text-center md:text-left animate__animated animate__fadeIn");
    			add_location(div0, file$2, 7, 4, 158);
    			attr_dev(span0, "class", "titulo__personales svelte-7gmkau");
    			add_location(span0, file$2, 15, 10, 395);
    			attr_dev(span1, "class", "datos__personales svelte-7gmkau");
    			add_location(span1, file$2, 15, 57, 442);
    			add_location(li0, file$2, 14, 8, 380);
    			attr_dev(span2, "class", "titulo__personales svelte-7gmkau");
    			add_location(span2, file$2, 20, 10, 572);
    			attr_dev(span3, "class", "datos__personales svelte-7gmkau");
    			add_location(span3, file$2, 20, 55, 617);
    			add_location(li1, file$2, 19, 8, 557);
    			attr_dev(span4, "class", "titulo__personales svelte-7gmkau");
    			add_location(span4, file$2, 25, 10, 727);
    			attr_dev(span5, "class", "datos__personales svelte-7gmkau");
    			add_location(span5, file$2, 25, 56, 773);
    			add_location(li2, file$2, 24, 8, 712);
    			attr_dev(span6, "class", "titulo__personales svelte-7gmkau");
    			add_location(span6, file$2, 32, 10, 911);
    			attr_dev(a, "href", "mailto:fjmgqba@gmail.com");
    			add_location(a, file$2, 35, 12, 1025);
    			attr_dev(span7, "class", "datos__personales svelte-7gmkau");
    			add_location(span7, file$2, 32, 56, 957);
    			add_location(li3, file$2, 31, 8, 896);
    			add_location(ul, file$2, 13, 6, 367);
    			attr_dev(div1, "class", "py-4 text-left md:text-right");
    			add_location(div1, file$2, 12, 4, 318);
    			attr_dev(div2, "class", "grid grid-cols-1 md:grid-cols-2 m-6");
    			add_location(div2, file$2, 6, 2, 104);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 30, 2, 934);
    			attr_dev(div1, "class", div1_class_value = `container mx-auto ${/*texto*/ ctx[0]} ${/*fondo*/ ctx[1]} rounded-lg px-6 py-8 shadow-xl dark:bg-slate-900`);
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*texto, fondo*/ 3 && div1_class_value !== (div1_class_value = `container mx-auto ${/*texto*/ ctx[0]} ${/*fondo*/ ctx[1]} rounded-lg px-6 py-8 shadow-xl dark:bg-slate-900`)) {
